...
s = S3Bucket(name='www.i3dbotfarm.xyz', access_key=botoConfig.aws_access_key_id, secret_key=botoConfig.aws_secret_access_key, base_url='www.i3dbotfarm.xyz.s3-website-us-west-2.amazonaws.com')
